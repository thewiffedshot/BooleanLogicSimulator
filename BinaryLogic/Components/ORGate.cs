...
namespace BinaryLogic.Components
{
    internal class ORGate : Component
    {
        public ORGate(Scene scene, Point position) 
            : base(ComponentType.OR, new ComponentHitbox(new Rectangle(position, (int)scene.GetGridInterval() * 2, (int)scene.GetGridInterval() * 2)))
        {
            ...
            arcs[2] = new Arc(indent + new Point(0, (int)(interval * 2) - (int)(2 * YIndent)),
        ...
        public override void Scale(Scene scene, bool zoom)
        {
            ...
            arcs[0] = new Arc(indent,
                              indent + new Point(0, (int)(interval * 2) - (int)(2 * YIndent * scene.ScaleFactor)),
                              indent + new Point((int)(interval / 2), (int)(interval * 2 / 3f)),
                              indent + new Point(0, (int)(interval * 2) - (int)(2 * YIndent * scene.ScaleFactor))
                                     + new Point((int)(interval / 2), -(int)(interval * 2 / 3f)));

            arcs[1] = new Arc(indent,
                              indent + new Point((int)interval * 2 - (int)(2 * XIndent * scene.ScaleFactor), (int)(interval - YIndent * scene.ScaleFactor)),
                              indent + new Point((int)(interval * 4.5f / 3f), 0),
                              indent + new Point((int)(interval * 5f / 3f), (int)(interval * 1 / 2f)));

            arcs[2] = new Arc(indent + new Point(0, (int)(interval * 2) - (int)(2 * YIndent * scene.ScaleFactor)),

                              indent + new Point(0, (int)(interval * 2) - (int)(2 * YIndent * scene.ScaleFactor))
                                     + new Point((int)interval * 2 - (int)(2 * XIndent * scene.ScaleFactor), -(int)(interval - YIndent * scene.ScaleFactor)),
